...
var css=opts.rowStyler?opts.rowStyler.call(_730,_731,rows[_731]):"";
var _732="";
var _733="";
if(typeof css=="string"){
_733=css;
...
var _732="datagrid-row "+(_731%2&&opts.striped?"datagrid-row-alt ":" ")+_732;
function _734(_735){
var _736=$(_730).datagrid("getColumnFields",_735);
var tr=opts.finder.getTr(_730,_731,"body",(_735?1:2));
var _737=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow.call(this,_730,_736,_735,_731,rows[_731]));
tr.attr("style",_733).attr("class",tr.hasClass("datagrid-row-selected")?_732+" datagrid-row-selected":_732);
if(_737){
...
},insertRow:function(_738,_739,row){
var _73a=$.data(_738,"datagrid");
var opts=_73a.options;
var dc=_73a.dc;
var data=_73a.data;
if(_739==undefined||_739==null){
_739=data.rows.length;
}
if(_739>data.rows.length){
_739=data.rows.length;
}
function _73b(_73c){
var _73d=_73c?1:2;
for(var i=data.rows.length-1;i>=_739;i--){
var tr=opts.finder.getTr(_738,i,"body",_73d);
tr.attr("datagrid-row-index",i+1);
tr.attr("id",_73a.rowIdPrefix+"-"+_73d+"-"+(i+1));
if(_73c&&opts.rownumbers){
var _73e=i+2;
if(opts.pagination){
_73e+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_73e);
}
if(opts.striped){
...
function _73f(_740){
var _741=_740?1:2;
var _742=$(_738).datagrid("getColumnFields",_740);
var _743=_73a.rowIdPrefix+"-"+_741+"-"+_739;
var tr="<tr id=\""+_743+"\" class=\"datagrid-row\" datagrid-row-index=\""+_739+"\"></tr>";
if(_739>=data.rows.length){
if(data.rows.length){
opts.finder.getTr(_738,"","last",_741).after(tr);
}else{
var cc=_740?dc.body1:dc.body2;
cc.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
opts.finder.getTr(_738,_739+1,"body",_741).before(tr);
}
};
_73b.call(this,true);
_73b.call(this,false);
_73f.call(this,true);
_73f.call(this,false);
data.total+=1;
data.rows.splice(_739,0,row);
this.refreshRow.call(this,_738,_739);
},deleteRow:function(_744,_745){
var _746=$.data(_744,"datagrid");
var opts=_746.options;
var data=_746.data;
function _747(_748){
var _749=_748?1:2;
for(var i=_745+1;i<data.rows.length;i++){
var tr=opts.finder.getTr(_744,i,"body",_749);
tr.attr("datagrid-row-index",i-1);
tr.attr("id",_746.rowIdPrefix+"-"+_749+"-"+(i-1));
if(_748&&opts.rownumbers){
var _74a=i;
if(opts.pagination){
_74a+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_74a);
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
opts.finder.getTr(_744,_745).remove();
_747.call(this,true);
_747.call(this,false);
data.total-=1;
data.rows.splice(_745,1);
},onBeforeRender:function(_74b,rows){
},onAfterRender:function(_74c){
var opts=$.data(_74c,"datagrid").options;
if(opts.showFooter){
var _74d=$(_74c).datagrid("getPanel").find("div.datagrid-footer");
_74d.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_74e,_74f){
},loader:function(_750,_751,_752){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_750,dataType:"json",success:function(data){
_751(data);
},error:function(){
_752.apply(this,arguments);
}});
...
},editors:_6ca,finder:{getTr:function(_753,_754,type,_755){
type=type||"body";
_755=_755||0;
var _756=$.data(_753,"datagrid");
var dc=_756.dc;
var opts=_756.options;
if(_755==0){
var tr1=opts.finder.getTr(_753,_754,type,1);
var tr2=opts.finder.getTr(_753,_754,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_756.rowIdPrefix+"-"+_755+"-"+_754);
if(!tr.length){
tr=(_755==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_754+"]");
}
return tr;
}else{
if(type=="footer"){
return (_755==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_754+"]");
}else{
if(type=="selected"){
return (_755==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_755==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_755==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_755==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_755==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_755==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_757,p){
var _758=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_757,"datagrid").data.rows[parseInt(_758)];
},getRows:function(_759){
return $(_759).datagrid("getRows");
}},view:_713,onBeforeLoad:function(_75a){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_75b,_75c){
},onDblClickRow:function(_75d,_75e){
},onClickCell:function(_75f,_760,_761){
},onDblClickCell:function(_762,_763,_764){
},onBeforeSortColumn:function(sort,_765){
},onSortColumn:function(sort,_766){
},onResizeColumn:function(_767,_768){
},onSelect:function(_769,_76a){
},onUnselect:function(_76b,_76c){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onCheck:function(_76d,_76e){
},onUncheck:function(_76f,_770){
},onCheckAll:function(rows){
},onUncheckAll:function(rows){
},onBeforeEdit:function(_771,_772){
},onBeginEdit:function(_773,_774){
},onEndEdit:function(_775,_776,_777){
},onAfterEdit:function(_778,_779,_77a){
},onCancelEdit:function(_77b,_77c){
},onHeaderContextMenu:function(e,_77d){
},onRowContextMenu:function(e,_77e,_77f){
}});
})(jQuery);
(function($){
var _780;
function _781(_782){
var _783=$.data(_782,"propertygrid");
var opts=$.data(_782,"propertygrid").options;
$(_782).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?opts.groupView:opts.view),onClickCell:function(_784,_785,_786){
if(_780!=this){
_787(_780);
_780=this;
}
var row=$(this).datagrid("getRows")[_784];
if(opts.editIndex!=_784&&row.editor){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_787(_780);
$(this).datagrid("beginEdit",_784);
var ed=$(this).datagrid("getEditor",{index:_784,field:_785});
if(!ed){
ed=$(this).datagrid("getEditor",{index:_784,field:"value"});
}
if(ed){
_788(ed.target).focus();
opts.editIndex=_784;
}
}
opts.onClickCell.call(_782,_784,_785,_786);
},loadFilter:function(data){
_787(this);
...
var _78a=opts.editIndex;
if(_78a==undefined){
return;
}
var _78b=t.datagrid("getEditors",_78a);
if(_78b.length){
$.map(_78b,function(ed){
_788(ed.target).blur();
});
if(t.datagrid("validateRow",_78a)){
t.datagrid("endEdit",_78a);
}else{
t.datagrid("cancelEdit",_78a);
}
}
opts.editIndex=undefined;
};
$.fn.propertygrid=function(_78c,_78d){
if(typeof _78c=="string"){
var _78e=$.fn.propertygrid.methods[_78c];
if(_78e){
return _78e(this,_78d);
}else{
return this.datagrid(_78c,_78d);
}
}
_78c=_78c||{};
return this.each(function(){
var _78f=$.data(this,"propertygrid");
if(_78f){
$.extend(_78f.options,_78c);
}else{
var opts=$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_78c);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.columns=$.extend(true,[],opts.columns);
...
$.fn.propertygrid.parseOptions=function(_790){
return $.extend({},$.fn.datagrid.parseOptions(_790),$.parser.parseOptions(_790,[{showGroup:"boolean"}]));
};
var _791=$.extend({},$.fn.datagrid.defaults.view,{render:function(_792,_793,_794){
var _795=[];
var _796=this.groups;
for(var i=0;i<_796.length;i++){
_795.push(this.renderGroup.call(this,_792,i,_796[i],_794));
}
$(_793).html(_795.join(""));
},renderGroup:function(_797,_798,_799,_79a){
var _79b=$.data(_797,"datagrid");
var opts=_79b.options;
var _79c=$(_797).datagrid("getColumnFields",_79a);
var _79d=[];
_79d.push("<div class=\"datagrid-group\" group-index="+_798+">");
_79d.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_79d.push("<tr>");
if((_79a&&(opts.rownumbers||opts.frozenColumns.length))||(!_79a&&!(opts.rownumbers||opts.frozenColumns.length))){
_79d.push("<td style=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
}
_79d.push("<td style=\"border:0;\">");
if(!_79a){
_79d.push("<span class=\"datagrid-group-title\">");
_79d.push(opts.groupFormatter.call(_797,_799.value,_799.rows));
_79d.push("</span>");
}
_79d.push("</td>");
_79d.push("</tr>");
_79d.push("</tbody></table>");
_79d.push("</div>");
_79d.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
var _79e=_799.startIndex;
for(var j=0;j<_799.rows.length;j++){
var css=opts.rowStyler?opts.rowStyler.call(_797,_79e,_799.rows[j]):"";
var _79f="";
var _7a0="";
if(typeof css=="string"){
_7a0=css;
...
var cls="class=\"datagrid-row "+(_79e%2&&opts.striped?"datagrid-row-alt ":" ")+_79f+"\"";
var _7a1=_7a0?"style=\""+_7a0+"\"":"";
var _7a2=_79b.rowIdPrefix+"-"+(_79a?1:2)+"-"+_79e;
_79d.push("<tr id=\""+_7a2+"\" datagrid-row-index=\""+_79e+"\" "+cls+" "+_7a1+">");
_79d.push(this.renderRow.call(this,_797,_79c,_79a,_79e,_799.rows[j]));
_79d.push("</tr>");
_79e++;
}
_79d.push("</tbody></table>");
return _79d.join("");
},bindEvents:function(_7a3){
var _7a4=$.data(_7a3,"datagrid");
var dc=_7a4.dc;
var body=dc.body1.add(dc.body2);
var _7a5=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
body.unbind("click").bind("click",function(e){
var tt=$(e.target);
var _7a6=tt.closest("span.datagrid-row-expander");
if(_7a6.length){
var _7a7=_7a6.closest("div.datagrid-group").attr("group-index");
if(_7a6.hasClass("datagrid-row-collapse")){
$(_7a3).datagrid("collapseGroup",_7a7);
}else{
$(_7a3).datagrid("expandGroup",_7a7);
}
}else{
_7a5(e);
}
...
},onBeforeRender:function(_7a8,rows){
var _7a9=$.data(_7a8,"datagrid");
var opts=_7a9.options;
_7aa();
var _7ab=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _7ac=_7ad(row[opts.groupField]);
if(!_7ac){
_7ac={value:row[opts.groupField],rows:[row]};
_7ab.push(_7ac);
}else{
_7ac.rows.push(row);
}
...
var _7ac=_7ab[i];
_7ac.startIndex=_7ae;
_7ae+=_7ac.rows.length;
_7af=_7af.concat(_7ac.rows);
}
_7a9.data.rows=_7af;
this.groups=_7ab;
var that=this;
setTimeout(function(){
that.bindEvents(_7a8);
},0);
function _7ad(_7b0){
for(var i=0;i<_7ab.length;i++){
var _7b1=_7ab[i];
...
$.extend($.fn.datagrid.methods,{expandGroup:function(jq,_7b2){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _7b3=view.find(_7b2!=undefined?"div.datagrid-group[group-index=\""+_7b2+"\"]":"div.datagrid-group");
var _7b4=_7b3.find("span.datagrid-row-expander");
if(_7b4.hasClass("datagrid-row-expand")){
_7b4.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_7b3.next("table").show();
}
$(this).datagrid("fixRowHeight");
});
},collapseGroup:function(jq,_7b5){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _7b6=view.find(_7b5!=undefined?"div.datagrid-group[group-index=\""+_7b5+"\"]":"div.datagrid-group");
var _7b7=_7b6.find("span.datagrid-row-expander");
if(_7b7.hasClass("datagrid-row-collapse")){
_7b7.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_7b6.next("table").hide();
}
$(this).datagrid("fixRowHeight");
});
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_791,groupField:"group",groupFormatter:function(_7b8,rows){
return _7b8;
}});
})(jQuery);
(function($){
function _7b9(_7ba){
var _7bb=$.data(_7ba,"treegrid");
var opts=_7bb.options;
$(_7ba).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
return false;
},onLoadSuccess:function(){
},onResizeColumn:function(_7bc,_7bd){
_7d3(_7ba);
opts.onResizeColumn.call(_7ba,_7bc,_7bd);
},onSortColumn:function(sort,_7be){
opts.sortName=sort;
opts.sortOrder=_7be;
if(opts.remoteSort){
_7d2(_7ba);
}else{
var data=$(_7ba).treegrid("getData");
_7e8(_7ba,0,data);
}
opts.onSortColumn.call(_7ba,sort,_7be);
},onBeforeEdit:function(_7bf,row){
if(opts.onBeforeEdit.call(_7ba,row)==false){
return false;
}
},onAfterEdit:function(_7c0,row,_7c1){
opts.onAfterEdit.call(_7ba,row,_7c1);
},onCancelEdit:function(_7c2,row){
opts.onCancelEdit.call(_7ba,row);
},onSelect:function(_7c3){
opts.onSelect.call(_7ba,find(_7ba,_7c3));
},onUnselect:function(_7c4){
opts.onUnselect.call(_7ba,find(_7ba,_7c4));
},onCheck:function(_7c5){
opts.onCheck.call(_7ba,find(_7ba,_7c5));
},onUncheck:function(_7c6){
opts.onUncheck.call(_7ba,find(_7ba,_7c6));
},onClickRow:function(_7c7){
opts.onClickRow.call(_7ba,find(_7ba,_7c7));
},onDblClickRow:function(_7c8){
opts.onDblClickRow.call(_7ba,find(_7ba,_7c8));
},onClickCell:function(_7c9,_7ca){
opts.onClickCell.call(_7ba,_7ca,find(_7ba,_7c9));
},onDblClickCell:function(_7cb,_7cc){
opts.onDblClickCell.call(_7ba,_7cc,find(_7ba,_7cb));
},onRowContextMenu:function(e,_7cd){
opts.onContextMenu.call(_7ba,e,find(_7ba,_7cd));
}}));
if(!opts.columns){
var _7ce=$.data(_7ba,"datagrid").options;
opts.columns=_7ce.columns;
opts.frozenColumns=_7ce.frozenColumns;
}
_7bb.dc=$.data(_7ba,"datagrid").dc;
if(opts.pagination){
var _7cf=$(_7ba).datagrid("getPager");
_7cf.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_7d0,_7d1){
opts.pageNumber=_7d0;
opts.pageSize=_7d1;
_7d2(_7ba);
}});
opts.pageSize=_7cf.pagination("options").pageSize;
}
};
function _7d3(_7d4,_7d5){
var opts=$.data(_7d4,"datagrid").options;
var dc=$.data(_7d4,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight)){
if(_7d5!=undefined){
var _7d6=_7d7(_7d4,_7d5);
for(var i=0;i<_7d6.length;i++){
_7d8(_7d6[i][opts.idField]);
}
}
}
$(_7d4).datagrid("fixRowHeight",_7d5);
function _7d8(_7d9){
var tr1=opts.finder.getTr(_7d4,_7d9,"body",1);
var tr2=opts.finder.getTr(_7d4,_7d9,"body",2);
tr1.css("height","");
tr2.css("height","");
var _7da=Math.max(tr1.height(),tr2.height());
tr1.css("height",_7da);
tr2.css("height",_7da);
};
};
...
function _7dd(_7de){
var dc=$.data(_7de,"datagrid").dc;
var body=dc.body1.add(dc.body2);
var _7df=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
...
var tr1=opts.finder.getTr(_7e2,_7e3,"body",1);
var tr2=opts.finder.getTr(_7e2,_7e3,"body",2);
var _7e4=$(_7e2).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _7e5=$(_7e2).datagrid("getColumnFields",false).length;
_7e6(tr1,_7e4);
_7e6(tr2,_7e5);
function _7e6(tr,_7e7){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_7e7+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _7e8(_7e9,_7ea,data,_7eb){
var _7ec=$.data(_7e9,"treegrid");
var opts=_7ec.options;
var dc=_7ec.dc;
data=opts.loadFilter.call(_7e9,data,_7ea);
var node=find(_7e9,_7ea);
if(node){
var _7ed=opts.finder.getTr(_7e9,_7ea,"body",1);
var _7ee=opts.finder.getTr(_7e9,_7ea,"body",2);
var cc1=_7ed.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_7ee.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_7eb){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_7e9,_7ea,data);
}
opts.view.render.call(opts.view,_7e9,cc1,true);
opts.view.render.call(opts.view,_7e9,cc2,false);
if(opts.showFooter){
...
if(!_7ea&&opts.pagination){
var _7ef=$.data(_7e9,"treegrid").total;
var _7f0=$(_7e9).datagrid("getPager");
if(_7f0.pagination("options").total!=_7ef){
_7f0.pagination({total:_7ef});
}
}
_7d3(_7e9);
_7db(_7e9);
$(_7e9).treegrid("showLines");
$(_7e9).treegrid("setSelectionState");
$(_7e9).treegrid("autoSizeColumn");
opts.onLoadSuccess.call(_7e9,node,data);
};
function _7d2(_7f1,_7f2,_7f3,_7f4,_7f5){
var opts=$.data(_7f1,"treegrid").options;
var body=$(_7f1).datagrid("getPanel").find("div.datagrid-body");
if(_7f3){
opts.queryParams=_7f3;
}
var _7f6=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_7f6,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_7f6,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_7f1,_7f2);
if(opts.onBeforeLoad.call(_7f1,row,_7f6)==false){
return;
}
var _7f7=body.find("tr[node-id=\""+_7f2+"\"] span.tree-folder");
_7f7.addClass("tree-loading");
$(_7f1).treegrid("loading");
var _7f8=opts.loader.call(_7f1,_7f6,function(data){
_7f7.removeClass("tree-loading");
$(_7f1).treegrid("loaded");
_7e8(_7f1,_7f2,data,_7f4);
if(_7f5){
_7f5();
}
},function(){
_7f7.removeClass("tree-loading");
$(_7f1).treegrid("loaded");
opts.onLoadError.apply(_7f1,arguments);
if(_7f5){
_7f5();
}
});
...
function _7fb(_7fc){
return $.data(_7fc,"treegrid").data;
};
function _7fd(_7fe,_7ff){
var row=find(_7fe,_7ff);
if(row._parentId){
return find(_7fe,row._parentId);
}else{
return null;
}
};
function _7d7(_800,_801){
var opts=$.data(_800,"treegrid").options;
var body=$(_800).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _802=[];
if(_801){
_803(_801);
}else{
...
_802.push(_804[i]);
_803(_804[i][opts.idField]);
}
}
function _803(_805){
var _806=find(_800,_805);
if(_806&&_806.children){
for(var i=0,len=_806.children.length;i<len;i++){
var _807=_806.children[i];
_802.push(_807);
_803(_807[opts.idField]);
}
}
};
return _802;
...
var view=$(_809).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id=\""+_80a+"\"]").children("td[field=\""+opts.treeField+"\"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_80b,_80c){
var opts=$.data(_80b,"treegrid").options;
var data=$.data(_80b,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_80c){
return node;
}else{
if(node["children"]){
...
var row=find(_80e,_80f);
var tr=opts.finder.getTr(_80e,_80f);
...
if(opts.onBeforeCollapse.call(_80e,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
$(_80e).treegrid("autoSizeColumn");
_7d3(_80e,_80f);
opts.onCollapse.call(_80e,row);
});
}else{
cc.hide();
$(_80e).treegrid("autoSizeColumn");
...
if(opts.onBeforeExpand.call(_811,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _813=tr.next("tr.treegrid-tr-tree");
if(_813.length){
var cc=_813.children("td").children("div");
_814(cc);
}else{
_7e1(_811,row[opts.idField]);
var _813=tr.next("tr.treegrid-tr-tree");
var cc=_813.children("td").children("div");
cc.hide();
var _815=$.extend({},opts.queryParams||{});
_815.id=row[opts.idField];
_7d2(_811,row[opts.idField],_815,true,function(){
if(cc.is(":empty")){
_813.remove();
}else{
_814(cc);
...
$(_811).treegrid("autoSizeColumn");
_7d3(_811,_812);
opts.onExpand.call(_811,row);
});
}else{
cc.show();
$(_811).treegrid("autoSizeColumn");
...
var _81b=_7d7(_819,_81a);
if(_81a){
_81b.unshift(find(_819,_81a));
}
for(var i=0;i<_81b.length;i++){
_80d(_819,_81b[i][opts.idField]);
}
};
function _81c(_81d,_81e){
var opts=$.data(_81d,"treegrid").options;
var _81f=_7d7(_81d,_81e);
if(_81e){
_81f.unshift(find(_81d,_81e));
}
for(var i=0;i<_81f.length;i++){
_810(_81d,_81f[i][opts.idField]);
}
};
function _820(_821,_822){
var opts=$.data(_821,"treegrid").options;
var ids=[];
var p=_7fd(_821,_822);
while(p){
...
if(_825.parent){
var tr=opts.finder.getTr(_824,_825.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_7e1(_824,_825.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _826=cell.children("span.tree-icon");
if(_826.hasClass("tree-file")){
_826.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_826);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_7e8(_824,_825.parent,_825.data,true);
};
function _827(_828,_829){
var ref=_829.before||_829.after;
var opts=$.data(_828,"treegrid").options;
var _82a=_7fd(_828,ref);
_823(_828,{parent:(_82a?_82a[opts.idField]:null),data:[_829.data]});
var _82b=_82a?_82a.children:$(_828).treegrid("getRoots");
for(var i=0;i<_82b.length;i++){
if(_82b[i][opts.idField]==ref){
var _82c=_82b[_82b.length-1];
_82b.splice(_829.before?i:(i+1),0,_82c);
_82b.splice(_82b.length-1,1);
break;
}
}
_82d(true);
_82d(false);
_7db(_828);
$(_828).treegrid("showLines");
function _82d(_82e){
var _82f=_82e?1:2;
var tr=opts.finder.getTr(_828,_829.data[opts.idField],"body",_82f);
var _830=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_828,ref,"body",_82f);
if(_829.before){
...
var _834=$.data(_832,"treegrid");
$(_832).datagrid("deleteRow",_833);
_7db(_832);
_834.total-=1;
$(_832).datagrid("getPager").pagination("refresh",{total:_834.total});
$(_832).treegrid("showLines");
};
function _835(_836){
var t=$(_836);
...
var _837=t.treegrid("getRoots");
if(_837.length>1){
_838(_837[0]).addClass("tree-root-first");
}else{
if(_837.length==1){
_838(_837[0]).addClass("tree-root-one");
}
}
_839(_837);
_83a(_837);
function _839(_83b){
$.map(_83b,function(node){
...
var cell=_838(_83b[_83b.length-1]);
cell.addClass("tree-node-last");
cell.find(".tree-join").removeClass("tree-join").addClass("tree-joinbottom");
};
function _83a(_83c){
$.map(_83c,function(node){
if(node.children&&node.children.length){
_83a(node.children);
}
});
for(var i=0;i<_83c.length-1;i++){
var node=_83c[i];
var _83d=t.treegrid("getLevel",node[opts.idField]);
var tr=opts.finder.getTr(_836,node[opts.idField]);
var cc=tr.next().find("tr.datagrid-row td[field=\""+opts.treeField+"\"] div.datagrid-cell");
cc.find("span:eq("+(_83d-1)+")").addClass("tree-line");
}
};
function _838(node){
var tr=opts.finder.getTr(_836,node[opts.idField]);
...
$.fn.treegrid=function(_83e,_83f){
if(typeof _83e=="string"){
var _840=$.fn.treegrid.methods[_83e];
if(_840){
return _840(this,_83f);
}else{
return this.datagrid(_83e,_83f);
}
}
_83e=_83e||{};
return this.each(function(){
var _841=$.data(this,"treegrid");
if(_841){
$.extend(_841.options,_83e);
}else{
_841=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_83e),data:[]});
}
_7b9(this);
if(_841.options.data){
$(this).treegrid("loadData",_841.options.data);
}
_7d2(this);
_7dd(this);
});
...
},resize:function(jq,_842){
return jq.each(function(){
$(this).datagrid("resize",_842);
});
},fixRowHeight:function(jq,_843){
return jq.each(function(){
_7d3(this,_843);
});
},loadData:function(jq,data){
return jq.each(function(){
_7e8(this,data.parent,data);
});
},load:function(jq,_844){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_844);
});
...
_845=$.extend({},opts.queryParams);
_845.id=id;
}
if(_845.id){
var node=$(this).treegrid("find",_845.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_845;
var tr=opts.finder.getTr(this,_845.id);
...
},reloadFooter:function(jq,_846){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_846){
$.data(this,"treegrid").footer=_846;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_847){
return jq.each(function(){
_823(this,_847);
});
},insert:function(jq,_848){
return jq.each(function(){
_827(this,_848);
});
...
},update:function(jq,_849){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
opts.view.updateRow.call(opts.view,this,_849.id,_849.row);
});
...
$.fn.treegrid.parseOptions=function(_84a){
return $.extend({},$.fn.datagrid.parseOptions(_84a),$.parser.parseOptions(_84a,["treeField",{animate:"boolean"}]));
};
var _84b=$.extend({},$.fn.datagrid.defaults.view,{render:function(_84c,_84d,_84e){
var opts=$.data(_84c,"treegrid").options;
var _84f=$(_84c).datagrid("getColumnFields",_84e);
var _850=$.data(_84c,"datagrid").rowIdPrefix;
if(_84e){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _851=_852(_84e,this.treeLevel,this.treeNodes);
$(_84d).append(_851.join(""));
}
function _852(_853,_854,_855){
var _856=$(_84c).treegrid("getParent",_855[0][opts.idField]);
var _857=(_856?_856.children.length:$(_84c).treegrid("getRoots").length)-_855.length;
var _858=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_855.length;i++){
var row=_855[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_84c,row):"";
var _859="";
var _85a="";
if(typeof css=="string"){
_85a=css;
...
var cls="class=\"datagrid-row "+(_857++%2&&opts.striped?"datagrid-row-alt ":" ")+_859+"\"";
var _85b=_85a?"style=\""+_85a+"\"":"";
var _85c=_850+"-"+(_853?1:2)+"-"+row[opts.idField];
_858.push("<tr id=\""+_85c+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_85b+">");
_858=_858.concat(view.renderRow.call(view,_84c,_84f,_853,_854,row));
_858.push("</tr>");
if(row.children&&row.children.length){
var tt=_852(_853,_854+1,row.children);
var v=row.state=="closed"?"none":"block";
_858.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_84f.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_858=_858.concat(tt);
_858.push("</div></td></tr>");
}
}
_858.push("</tbody></table>");
return _858;
};
},renderFooter:function(_85d,_85e,_85f){
var opts=$.data(_85d,"treegrid").options;
var rows=$.data(_85d,"treegrid").footer||[];
var _860=$(_85d).datagrid("getColumnFields",_85f);
var _861=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_861.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_861.push(this.renderRow.call(this,_85d,_860,_85f,0,row));
_861.push("</tr>");
}
_861.push("</tbody></table>");
$(_85e).html(_861.join(""));
},renderRow:function(_862,_863,_864,_865,row){
var opts=$.data(_862,"treegrid").options;
var cc=[];
if(_864&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_863.length;i++){
var _866=_863[i];
var col=$(_862).datagrid("getColumnOption",_866);
if(col){
var css=col.styler?(col.styler(row[_866],row)||""):"";
var _867="";
var _868="";
if(typeof css=="string"){
_868=css;
...
var cls=_867?"class=\""+_867+"\"":"";
var _869=col.hidden?"style=\"display:none;"+_868+"\"":(_868?"style=\""+_868+"\"":"");
cc.push("<td field=\""+_866+"\" "+cls+" "+_869+">");
var _869="";
if(!col.checkbox){
if(col.align){
_869+="text-align:"+col.align+";";
}
if(!opts.nowrap){
_869+="white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_869+="height:auto;";
}
...
cc.push(" name=\""+_866+"\" value=\""+(row[_866]!=undefined?row[_866]:"")+"\">");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_866],row);
}else{
val=row[_866];
}
if(_866==opts.treeField){
for(var j=0;j<_865;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
return cc.join("");
},refreshRow:function(_86a,id){
this.updateRow.call(this,_86a,id,{});
},updateRow:function(_86b,id,row){
var opts=$.data(_86b,"treegrid").options;
var _86c=$(_86b).treegrid("find",id);
$.extend(_86c,row);
var _86d=$(_86b).treegrid("getLevel",id)-1;
var _86e=opts.rowStyler?opts.rowStyler.call(_86b,_86c):"";
var _86f=$.data(_86b,"datagrid").rowIdPrefix;
var _870=_86c[opts.idField];
function _871(_872){
var _873=$(_86b).treegrid("getColumnFields",_872);
var tr=opts.finder.getTr(_86b,id,"body",(_872?1:2));
var _874=tr.find("div.datagrid-cell-rownumber").html();
var _875=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_86b,_873,_872,_86d,_86c));
tr.attr("style",_86e||"");
tr.find("div.datagrid-cell-rownumber").html(_874);
if(_875){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
if(_870!=id){
tr.attr("id",_86f+"-"+(_872?1:2)+"-"+_870);
tr.attr("node-id",_870);
}
};
_871.call(this,true);
_871.call(this,false);
$(_86b).treegrid("fixRowHeight",id);
},deleteRow:function(_876,id){
var opts=$.data(_876,"treegrid").options;
var tr=opts.finder.getTr(_876,id);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _877=del(id);
if(_877){
if(_877.children.length==0){
tr=opts.finder.getTr(_876,_877[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _878=$(_876).treegrid("getParent",id);
if(_878){
cc=_878.children;
}else{
cc=$(_876).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
},onBeforeRender:function(_879,_87a,data){
if($.isArray(_87a)){
data={total:_87a.length,rows:_87a};
_87a=null;
}
if(!data){
return false;
}
var _87b=$.data(_879,"treegrid");
var opts=_87b.options;
if(data.length==undefined){
if(data.footer){
_87b.footer=data.footer;
}
if(data.total){
_87b.total=data.total;
}
data=this.transfer(_879,_87a,data.rows);
}else{
...
row._parentId=_87e;
if(row.children&&row.children.length){
_87c(row.children,row[opts.idField]);
}
}
};
_87c(data,_87a);
}
var node=find(_879,_87a);
if(node){
if(node.children){
...
_87b.data=_87b.data.concat(data);
}
this.sort(_879,data);
this.treeNodes=data;
this.treeLevel=$(_879).treegrid("getLevel",_87a);
},sort:function(_87f,data){
var opts=$.data(_87f,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _880=opts.sortName.split(",");
var _881=opts.sortOrder.split(",");
_882(data);
}
function _882(rows){
...
var sn=_880[i];
var so=_881[i];
var col=$(_87f).treegrid("getColumnOption",sn);
var _883=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_883(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _884=rows[i].children;
if(_884&&_884.length){
_882(_884);
}
}
};
},transfer:function(_885,_886,data){
var opts=$.data(_885,"treegrid").options;
var rows=[];
for(var i=0;i<data.length;i++){
rows.push(data[i]);
}
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,lines:false,animate:false,singleSelect:true,view:_84b,loader:function(_888,_889,_88a){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_888,dataType:"json",success:function(data){
_889(data);
},error:function(){
_88a.apply(this,arguments);
}});
},loadFilter:function(data,_88b){
return data;
},finder:{getTr:function(_88c,id,type,_88d){
type=type||"body";
_88d=_88d||0;
var dc=$.data(_88c,"datagrid").dc;
if(_88d==0){
var opts=$.data(_88c,"treegrid").options;
var tr1=opts.finder.getTr(_88c,id,type,1);
var tr2=opts.finder.getTr(_88c,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_88c,"datagrid").rowIdPrefix+"-"+_88d+"-"+id);
if(!tr.length){
tr=(_88d==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_88d==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_88d==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_88d==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_88d==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_88d==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_88d==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_88d==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_88e,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_88e).treegrid("find",id);
},getRows:function(_88f){
return $(_88f).treegrid("getChildren");
}},onBeforeLoad:function(row,_890){
...
},onClickCell:function(_891,row){
},onDblClickCell:function(_892,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_893){
...
if(!_896.panel){
_896.panel=$("<div class=\"combo-panel\"></div>").appendTo("body");
_896.panel.panel({minWidth:opts.panelMinWidth,maxWidth:opts.panelMaxWidth,minHeight:opts.panelMinHeight,maxHeight:opts.panelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
...
var _897=$.data(_895,"combo");
if(_897){
_897.options.onHidePanel.call(_895);
}
}});
}
var _898=$.extend(true,[],opts.icons);
if(opts.hasDownArrow){
_898.push({iconCls:"combo-arrow",handler:function(e){
_89c(e.data.target);
}});
}
$(_895).addClass("combo-f").textbox($.extend({},opts,{icons:_898,onChange:function(){
}}));
$(_895).attr("comboName",$(_895).attr("textboxName"));
_896.combo=$(_895).next();
_896.combo.addClass("combo");
};
function _899(_89a){
var _89b=$.data(_89a,"combo");
_89b.panel.panel("destroy");
$(_89a).textbox("destroy");
};
function _89c(_89d){
var _89e=$.data(_89d,"combo").panel;
if(_89e.is(":visible")){
_89f(_89d);
}else{
var p=$(_89d).closest("div.combo-panel");
$("div.combo-panel:visible").not(_89e).not(p).panel("close");
$(_89d).combo("showPanel");
}
$(_89d).combo("textbox").focus();
};
function _8a0(_8a1){
$(_8a1).find(".combo-f").each(function(){
...
function _8a4(e){
var _8a5=e.data.target;
var _8a6=$.data(_8a5,"combo");
var opts=_8a6.options;
var _8a7=_8a6.panel;
if(!opts.editable){
_89c(_8a5);
}else{
var p=$(_8a5).closest("div.combo-panel");
$("div.combo-panel:visible").not(_8a7).not(p).panel("close");
}
};
function _8a8(e){
var _8a9=e.data.target;
var t=$(_8a9);
var _8aa=t.data("combo");
var opts=t.combo("options");
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_8a9,e);
break;
case 40:
opts.keyHandler.down.call(_8a9,e);
break;
case 37:
opts.keyHandler.left.call(_8a9,e);
break;
case 39:
opts.keyHandler.right.call(_8a9,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_8a9,e);
return false;
case 9:
case 27:
_89f(_8a9);
...
if(opts.editable){
if(_8aa.timer){
clearTimeout(_8aa.timer);
}
_8aa.timer=setTimeout(function(){
var q=t.combo("getText");
if(_8aa.previousText!=q){
_8aa.previousText=q;
t.combo("showPanel");
opts.keyHandler.query.call(_8a9,q,e);
t.combo("validate");
}
},opts.delay);
}
...
var _8ae=_8ad.combo;
var _8af=_8ad.panel;
var opts=$(_8ac).combo("options");
_8af.panel("move",{left:_8b0(),top:_8b1()});
if(_8af.panel("options").closed){
_8af.panel("open").panel("resize",{width:(opts.panelWidth?opts.panelWidth:_8ae._outerWidth()),height:opts.panelHeight});
opts.onShowPanel.call(_8ac);
}
(function(){
if(_8af.is(":visible")){
_8af.panel("move",{left:_8b0(),top:_8b1()});
...
function _8b0(){
var left=_8ae.offset().left;
if(opts.panelAlign=="right"){
left+=_8ae._outerWidth()-_8af._outerWidth();
}
if(left+_8af._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_8af._outerWidth();
}
if(left<0){
left=0;
}
...
function _8b1(){
var top=_8ae.offset().top+_8ae._outerHeight();
if(top+_8af._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_8ae.offset().top-_8af._outerHeight();
}
if(top<$(document).scrollTop()){
top=_8ae.offset().top+_8ae._outerHeight();
}
return top;
};
};
function _89f(_8b2){
var _8b3=$.data(_8b2,"combo").panel;
_8b3.panel("close");
};
function _8b4(_8b5){
...
$(_8b5).textbox("clear");
if(opts.multiple){
_8b7.find(".textbox-value").remove();
}else{
_8b7.find(".textbox-value").val("");
}
};
function _8b8(_8b9,text){
var _8ba=$.data(_8b9,"combo");
var _8bb=$(_8b9).textbox("getText");
if(_8bb!=text){
$(_8b9).textbox("setText",text);
_8ba.previousText=text;
}
};
function _8bc(_8bd){
var _8be=[];
var _8bf=$.data(_8bd,"combo").combo;
_8bf.find(".textbox-value").each(function(){
_8be.push($(this).val());
});
return _8be;
};
...
var _8c3=$.data(_8c1,"combo");
var opts=_8c3.options;
var _8c4=_8c3.combo;
var _8c5=_8bc(_8c1);
_8c4.find(".textbox-value").remove();
var name=$(_8c1).attr("textboxName")||"";
for(var i=0;i<_8c2.length;i++){
var _8c6=$("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_8c4);
_8c6.attr("name",name);
if(opts.disabled){
_8c6.attr("disabled","disabled");
}
_8c6.val(_8c2[i]);
}
var _8c7=(function(){
if(_8c5.length!=_8c2.length){
return true;
}
var a1=$.extend(true,[],_8c5);
var a2=$.extend(true,[],_8c2);
a1.sort();
a2.sort();
...
if(_8c7){
if(opts.multiple){
opts.onChange.call(_8c1,_8c2,_8c5);
}else{
opts.onChange.call(_8c1,_8c2[0],_8c5[0]);
}
}
};
function _8c8(_8c9){
...
function _8ce(_8cf){
var opts=$.data(_8cf,"combo").options;
var _8d0=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
_8c0(_8cf,opts.value?opts.value:[]);
}else{
_8cb(_8cf,opts.value);
}
opts.onChange=_8d0;
};
$.fn.combo=function(_8d1,_8d2){
if(typeof _8d1=="string"){
var _8d3=$.fn.combo.methods[_8d1];
if(_8d3){
return _8d3(this,_8d2);
}else{
return this.textbox(_8d1,_8d2);
}
}
_8d1=_8d1||{};
return this.each(function(){
var _8d4=$.data(this,"combo");
if(_8d4){
$.extend(_8d4.options,_8d1);
if(_8d1.value!=undefined){
_8d4.options.originalValue=_8d1.value;
}
}else{
_8d4=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_8d1),previousText:""});
_8d4.options.originalValue=_8d4.options.value;
}
_894(this);
_8a2(this);
_8ce(this);
...
return _8bc(jq[0]);
},setValues:function(jq,_8d5){
return jq.each(function(){
_8c0(this,_8d5);
});
},getValue:function(jq){
return _8c8(jq[0]);
},setValue:function(jq,_8d6){
return jq.each(function(){
_8cb(this,_8d6);
});
}};
$.fn.combo.parseOptions=function(_8d7){
var t=$(_8d7);
return $.extend({},$.fn.textbox.parseOptions(_8d7),$.parser.parseOptions(_8d7,["separator","panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_8a4,keydown:_8a8,paste:_8a8,drop:_8a8},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
},onChange:function(_8d8,_8d9){
}});
})(jQuery);
(function($){
var _8da=0;
function _8db(_8dc,_8dd){
var _8de=$.data(_8dc,"combobox");
var opts=_8de.options;
var data=_8de.data;
for(var i=0;i<data.length;i++){
if(data[i][opts.valueField]==_8dd){
return i;
}
}
return -1;
...
var opts=$.data(_8e0,"combobox").options;
var _8e2=$(_8e0).combo("panel");
var item=opts.finder.getEl(_8e0,_8e1);
if(item.length){
if(item.position().top<=0){
var h=_8e2.scrollTop()+item.position().top;
_8e2.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_8e2.height()){
var h=_8e2.scrollTop()+item.position().top+item.outerHeight()-_8e2.height();
_8e2.scrollTop(h);
}
}
}
};
function nav(_8e3,dir){
var opts=$.data(_8e3,"combobox").options;
var _8e4=$(_8e3).combobox("panel");
var item=_8e4.children("div.combobox-item-hover");
if(!item.length){
item=_8e4.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _8e5="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _8e6="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_8e4.children(dir=="next"?_8e5:_8e6);
}else{
if(dir=="next"){
item=item.nextAll(_8e5);
if(!item.length){
item=_8e4.children(_8e5);
}
}else{
item=item.prevAll(_8e5);
if(!item.length){
item=_8e4.children(_8e6);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=opts.finder.getRow(_8e3,item);
if(row){
_8df(_8e3,row[opts.valueField]);
if(opts.selectOnNavigation){
_8e7(_8e3,row[opts.valueField]);
}
}
}
};
...
_8eb(_8e8,_8ea);
opts.onSelect.call(_8e8,opts.finder.getRow(_8e8,_8e9));
}
};
function _8ec(_8ed,_8ee){
var opts=$.data(_8ed,"combobox").options;
var _8ef=$(_8ed).combo("getValues");
var _8f0=$.inArray(_8ee+"",_8ef);
if(_8f0>=0){
_8ef.splice(_8f0,1);
_8eb(_8ed,_8ef);
opts.onUnselect.call(_8ed,opts.finder.getRow(_8ed,_8ee));
}
};
function _8eb(_8f1,_8f2,_8f3){
var opts=$.data(_8f1,"combobox").options;
var _8f4=$(_8f1).combo("panel");
_8f4.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
for(var i=0;i<_8f2.length;i++){
var v=_8f2[i];
var s=v;
opts.finder.getEl(_8f1,v).addClass("combobox-item-selected");
var row=opts.finder.getRow(_8f1,v);
if(row){
...
$(_8f1).combo("setValues",vv);
if(!_8f3){
$(_8f1).combo("setText",ss.join(opts.separator));
}
};
function _8f5(_8f6,data,_8f7){
var _8f8=$.data(_8f6,"combobox");
var opts=_8f8.options;
_8f8.data=opts.loadFilter.call(_8f6,data);
_8f8.groups=[];
data=_8f8.data;
var _8f9=$(_8f6).combobox("getValues");
var dd=[];
var _8fa=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
...
_8fa=g;
_8f8.groups.push(g);
dd.push("<div id=\""+(_8f8.groupIdPrefix+"_"+(_8f8.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_8f6,g):g);
dd.push("</div>");
}
}else{
_8fa=undefined;
...
dd.push("<div id=\""+(_8f8.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_8f6,row):s);
dd.push("</div>");
if(row["selected"]&&$.inArray(v,_8f9)==-1){
_8f9.push(v);
}
}
$(_8f6).combo("panel").html(dd.join(""));
if(opts.multiple){
_8eb(_8f6,_8f9,_8f7);
}else{
_8eb(_8f6,_8f9.length?[_8f9[_8f9.length-1]]:[],_8f7);
}
opts.onLoadSuccess.call(_8f6,data);
};
function _8fb(_8fc,url,_8fd,_8fe){
var opts=$.data(_8fc,"combobox").options;
if(url){
opts.url=url;
}
_8fd=_8fd||{};
if(opts.onBeforeLoad.call(_8fc,_8fd)==false){
return;
}
opts.loader.call(_8fc,_8fd,function(data){
_8f5(_8fc,data,_8fe);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _8ff(_900,q){
var _901=$.data(_900,"combobox");
...
if(opts.mode=="remote"){
_8fb(_900,null,{q:q},true);
}else{
var _902=$(_900).combo("panel");
_902.find("div.combobox-item-selected,div.combobox-item-hover").removeClass("combobox-item-selected combobox-item-hover");
_902.find("div.combobox-item,div.combobox-group").hide();
var data=_901.data;
var vv=[];
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_900,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_900,v).show();
if(s.toLowerCase()==q.toLowerCase()){
vv.push(v);
item.addClass("combobox-item-selected");
}
if(opts.groupField&&_903!=g){
$("#"+_901.groupIdPrefix+"_"+$.inArray(g,_901.groups)).show();
_903=g;
}
}
}
...
var _906=t.combobox("panel");
var item=_906.children("div.combobox-item-hover");
if(item.length){
var row=opts.finder.getRow(_905,item);
var _907=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_907);
}else{
t.combobox("select",_907);
}
}else{
t.combobox("select",_907);
}
...
_8da++;
_90a.itemIdPrefix="_easyui_combobox_i"+_8da;
_90a.groupIdPrefix="_easyui_combobox_g"+_8da;
$(_909).addClass("combobox-f");
$(_909).combo($.extend({},opts,{onShowPanel:function(){
$(_909).combo("panel").find("div.combobox-item,div.combobox-group").show();
_8df(_909,$(_909).combobox("getValue"));
opts.onShowPanel.call(_909);
}}));
$(_909).combo("panel").unbind().bind("mouseover",function(e){
...
var row=opts.finder.getRow(_909,item);
if(!row){
return;
}
var _90b=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_8ec(_909,_90b);
}else{
...
$.fn.combobox=function(_90c,_90d){
if(typeof _90c=="string"){
var _90e=$.fn.combobox.methods[_90c];
if(_90e){
return _90e(this,_90d);
}else{
return this.combo(_90c,_90d);
}
}
_90c=_90c||{};
return this.each(function(){
var _90f=$.data(this,"combobox");
if(_90f){
$.extend(_90f.options,_90c);
_908(this);
}else{
_90f=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_90c),data:[]});
_908(this);
...
_8f5(this,_90f.options.data);
}
_8fb(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _910=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_910.width,height:_910.height,originalValue:_910.originalValue,disabled:_910.disabled,readonly:_910.readonly});
},getData:function(jq){
return $.data(jq[0],"combobox").data;
},setValues:function(jq,_911){
return jq.each(function(){
_8eb(this,_911);
});
},setValue:function(jq,_912){
return jq.each(function(){
_8eb(this,[_912]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _913=$(this).combo("panel");
_913.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_914){
return jq.each(function(){
_8e7(this,_914);
});
},unselect:function(jq,_915){
return jq.each(function(){
_8ec(this,_915);
});
}};
$.fn.combobox.parseOptions=function(_916){
var t=$(_916);
return $.extend({},$.fn.combo.parseOptions(_916),$.parser.parseOptions(_916,["valueField","textField","groupField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_917){
var data=[];
var opts=$(_917).combobox("options");
$(_917).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _918=$(this).attr("label");
...
row[opts.groupField]=_91a;
}
data.push(row);
};
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_91b){
return _91b;
...
return data;
},finder:{getEl:function(_91f,_920){
var _921=_8db(_91f,_920);
var id=$.data(_91f,"combobox").itemIdPrefix+"_"+_921;
return $("#"+id);
},getRow:function(_922,p){
var _923=$.data(_922,"combobox");
var _924=(p instanceof jQuery)?p.attr("id").substr(_923.itemIdPrefix.length+1):_8db(_922,p);
return _923.data[parseInt(_924)];
}},onBeforeLoad:function(_925){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_926){
},onUnselect:function(_927){
}});
})(jQuery);
(function($){
function _928(_929){
var _92a=$.data(_929,"combotree");
var opts=_92a.options;
var tree=_92a.tree;
$(_929).addClass("combotree-f");
$(_929).combo(opts);
var _92b=$(_929).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_92b);
$.data(_929,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _92c=$(_929).combotree("getValues");
if(opts.multiple){
var _92d=tree.tree("getChecked");
...
var _92e=$(this).tree("options");
var _92f=_92e.onCheck;
var _930=_92e.onSelect;
_92e.onCheck=_92e.onSelect=function(){
};
$(_929).combotree("setValues",_92c);
_92e.onCheck=_92f;
_92e.onSelect=_930;
...
},onCheck:function(node,_931){
_932(_929);
opts.onCheck.call(this,node,_931);
}}));
};
function _932(_933){
var _934=$.data(_933,"combotree");
var opts=_934.options;
var tree=_934.tree;
var vv=[],ss=[];
if(opts.multiple){
var _935=tree.tree("getChecked");
...
$(_933).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _936(_937,_938){
var opts=$.data(_937,"combotree").options;
var tree=$.data(_937,"combotree").tree;
...
$(_937).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_939,_93a){
if(typeof _939=="string"){
var _93b=$.fn.combotree.methods[_939];
if(_93b){
return _93b(this,_93a);
}else{
return this.combo(_939,_93a);
}
}
_939=_939||{};
return this.each(function(){
var _93c=$.data(this,"combotree");
if(_93c){
$.extend(_93c.options,_939);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_939)});
}
_928(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _93d=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_93d.width,height:_93d.height,originalValue:_93d.originalValue,disabled:_93d.disabled,readonly:_93d.readonly});
},tree:function(jq){
...
},setValues:function(jq,_93e){
return jq.each(function(){
_936(this,_93e);
});
},setValue:function(jq,_93f){
return jq.each(function(){
_936(this,[_93f]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_940){
return $.extend({},$.fn.combo.parseOptions(_940),$.fn.tree.parseOptions(_940));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _941(_942){
var _943=$.data(_942,"combogrid");
var opts=_943.options;
var grid=_943.grid;
$(_942).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combogrid("panel");
var _944=p.outerHeight()-p.height();
var _945=p._size("minHeight");
var _946=p._size("maxHeight");
$(this).combogrid("grid").datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_945?_945-_944:""),maxHeight:(_946?_946-_944:"")});
opts.onShowPanel.call(this);
}}));
var _947=$(_942).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_947);
_943.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _948=$(_942).combo("getValues");
var _949=opts.onSelect;
opts.onSelect=function(){
};
_953(_942,_948,_943.remainText);
opts.onSelect=_949;
opts.onLoadSuccess.apply(_942,arguments);
},onClickRow:_94a,onSelect:function(_94b,row){
_94c();
opts.onSelect.call(this,_94b,row);
},onUnselect:function(_94d,row){
_94c();
opts.onUnselect.call(this,_94d,row);
},onSelectAll:function(rows){
_94c();
...
function _94a(_94e,row){
_943.remainText=false;
_94c();
if(!opts.multiple){
$(_942).combo("hidePanel");
}
opts.onClickRow.call(this,_94e,row);
};
function _94c(){
...
if(!opts.multiple){
$(_942).combo("setValues",(vv.length?vv:[""]));
}else{
...
function nav(_94f,dir){
var _950=$.data(_94f,"combogrid");
var opts=_950.options;
var grid=_950.grid;
var _951=grid.datagrid("getRows").length;
if(!_951){
return;
}
...
var _952;
if(!tr.length){
_952=(dir=="next"?0:_951-1);
}else{
var _952=parseInt(tr.attr("datagrid-row-index"));
_952+=(dir=="next"?1:-1);
if(_952<0){
_952=_951-1;
}
...
grid.datagrid("highlightRow",_952);
if(opts.selectOnNavigation){
_950.remainText=false;
grid.datagrid("selectRow",_952);
}
};
function _953(_954,_955,_956){
var _957=$.data(_954,"combogrid");
var opts=_957.options;
var grid=_957.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _958=$(_954).combo("getValues");
var _959=$(_954).combo("options");
var _95a=_959.onChange;
_959.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_955.length;i++){
var _95b=grid.datagrid("getRowIndex",_955[i]);
if(_95b>=0){
grid.datagrid("selectRow",_95b);
ss.push(rows[_95b][opts.textField]);
}else{
ss.push(_955[i]);
}
}
$(_954).combo("setValues",_958);
_959.onChange=_95a;
$(_954).combo("setValues",_955);
if(!_956){
var s=ss.join(opts.separator);
if($(_954).combo("getText")!=s){
$(_954).combo("setText",s);
}
}
};
function _95c(_95d,q){
var _95e=$.data(_95d,"combogrid");
var opts=_95e.options;
var grid=_95e.grid;
_95e.remainText=true;
if(opts.multiple&&!q){
_953(_95d,[],true);
}else{
_953(_95d,[q],true);
...
if(opts.filter.call(_95d,q,row)){
...
function _95f(_960){
var _961=$.data(_960,"combogrid");
var opts=_961.options;
var grid=_961.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_961.remainText=false;
if(tr.length){
var _962=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_962);
}else{
...
$(_960).combogrid("setValues",vv);
if(!opts.multiple){
$(_960).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_963,_964){
if(typeof _963=="string"){
var _965=$.fn.combogrid.methods[_963];
if(_965){
return _965(this,_964);
}else{
return this.combo(_963,_964);
}
}
_963=_963||{};
return this.each(function(){
var _966=$.data(this,"combogrid");
if(_966){
$.extend(_966.options,_963);
}else{
_966=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_963)});
}
_941(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _967=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_967.width,height:_967.height,originalValue:_967.originalValue,disabled:_967.disabled,readonly:_967.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_968){
return jq.each(function(){
_953(this,_968);
});
},setValue:function(jq,_969){
return jq.each(function(){
_953(this,[_969]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_96a){
var t=$(_96a);
return $.extend({},$.fn.combo.parseOptions(_96a),$.fn.datagrid.parseOptions(_96a),$.parser.parseOptions(_96a,["idField","textField","mode"]));
};
...
(function($){
function _96b(_96c){
var _96d=$.data(_96c,"datebox");
var opts=_96d.options;
$(_96c).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_96e();
_976(_96c,$(_96c).datebox("getText"),true);
opts.onShowPanel.call(_96c);
}}));
$(_96c).combo("textbox").parent().addClass("datebox");
if(!_96d.calendar){
_96f();
}
_976(_96c,opts.value);
function _96f(){
var _970=$(_96c).combo("panel").css("overflow","hidden");
_970.panel("options").onBeforeDestroy=function(){
var sc=$(this).find(".calendar-shared");
if(sc.length){
sc.insertBefore(sc[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").appendTo(_970);
...
_96d.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_96d.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var opts=$(this.target).datebox("options");
_976(this.target,opts.formatter.call(this.target,date));
$(this.target).combo("hidePanel");
opts.onSelect.call(_96c,date);
}});
var _971=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_970);
var tr=_971.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_96c):btn.text).appendTo(td);
t.bind("click",{target:_96c,handler:btn.handler},function(e){
...
function _96e(){
var _972=$(_96c).combo("panel");
var cc=_972.children("div.datebox-calendar-inner");
_972.children()._outerWidth(_972.width());
_96d.calendar.appendTo(cc);
_96d.calendar[0].target=_96c;
if(opts.panelHeight!="auto"){
var _973=_972.height();
_972.children().not(cc).each(function(){
_973-=$(this).outerHeight();
});
cc._outerHeight(_973);
}
_96d.calendar.calendar("resize");
};
};
...
function _977(_978){
var _979=$.data(_978,"datebox");
var opts=_979.options;
var _97a=_979.calendar.calendar("options").current;
if(_97a){
_976(_978,opts.formatter.call(_978,_97a));
$(_978).combo("hidePanel");
}
};
function _976(_97b,_97c,_97d){
var _97e=$.data(_97b,"datebox");
var opts=_97e.options;
var _97f=_97e.calendar;
$(_97b).combo("setValue",_97c);
_97f.calendar("moveTo",opts.parser.call(_97b,_97c));
if(!_97d){
if(_97c){
_97c=opts.formatter.call(_97b,_97f.calendar("options").current);
$(_97b).combo("setValue",_97c).combo("setText",_97c);
}else{
$(_97b).combo("setText",_97c);
}
}
};
$.fn.datebox=function(_980,_981){
if(typeof _980=="string"){
var _982=$.fn.datebox.methods[_980];
if(_982){
return _982(this,_981);
}else{
return this.combo(_980,_981);
}
}
_980=_980||{};
return this.each(function(){
var _983=$.data(this,"datebox");
if(_983){
$.extend(_983.options,_980);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_980)});
}
_96b(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _984=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_984.width,height:_984.height,originalValue:_984.originalValue,disabled:_984.disabled,readonly:_984.readonly});
...
$.fn.datebox.parseOptions=function(_986){
return $.extend({},$.fn.combo.parseOptions(_986),$.parser.parseOptions(_986,["sharedCalendar"]));
};
...
_974(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_987){
return $(_987).datebox("options").currentText;
},handler:function(_988){
$(_988).datebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_977(_988);
}},{text:function(_989){
return $(_989).datebox("options").closeText;
},handler:function(_98a){
...
(function($){
function _98b(_98c){
var _98d=$.data(_98c,"datetimebox");
var opts=_98d.options;
$(_98c).datebox($.extend({},opts,{onShowPanel:function(){
var _98e=$(_98c).datetimebox("getValue");
_990(_98c,_98e,true);
opts.onShowPanel.call(_98c);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_98c).removeClass("datebox-f").addClass("datetimebox-f");
$(_98c).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_98c,date);
}});
var _98f=$(_98c).datebox("panel");
if(!_98d.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_98f.children("div.datebox-calendar-inner"));
_98d.spinner=p.children("input");
}
_98d.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_990(_98c,opts.value);
};
function _991(_992){
var c=$(_992).datetimebox("calendar");
var t=$(_992).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _993(_994,q){
_990(_994,q,true);
};
function _995(_996){
var opts=$.data(_996,"datetimebox").options;
var date=_991(_996);
_990(_996,opts.formatter.call(_996,date));
$(_996).combo("hidePanel");
};
function _990(_997,_998,_999){
var opts=$.data(_997,"datetimebox").options;
$(_997).combo("setValue",_998);
if(!_999){
if(_998){
var date=opts.parser.call(_997,_998);
$(_997).combo("setValue",opts.formatter.call(_997,date));
$(_997).combo("setText",opts.formatter.call(_997,date));
}else{
$(_997).combo("setText",_998);
}
}
var date=opts.parser.call(_997,_998);
$(_997).datetimebox("calendar").calendar("moveTo",date);
$(_997).datetimebox("spinner").timespinner("setValue",_99a(date));
function _99a(date){
function _99b(_99c){
return (_99c<10?"0":"")+_99c;
};
var tt=[_99b(date.getHours()),_99b(date.getMinutes())];
if(opts.showSeconds){
tt.push(_99b(date.getSeconds()));
}
return tt.join($(_997).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_99d,_99e){
if(typeof _99d=="string"){
var _99f=$.fn.datetimebox.methods[_99d];
if(_99f){
return _99f(this,_99e);
}else{
return this.datebox(_99d,_99e);
}
}
_99d=_99d||{};
return this.each(function(){
var _9a0=$.data(this,"datetimebox");
if(_9a0){
$.extend(_9a0.options,_99d);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_99d)});
}
_98b(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _9a1=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_9a1.originalValue,disabled:_9a1.disabled,readonly:_9a1.readonly});
},spinner:function(jq){
...
$.fn.datetimebox.parseOptions=function(_9a3){
var t=$(_9a3);
return $.extend({},$.fn.datebox.parseOptions(_9a3),$.parser.parseOptions(_9a3,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_993(this,q);
}},buttons:[{text:function(_9a4){
return $(_9a4).datetimebox("options").currentText;
},handler:function(_9a5){
$(_9a5).datetimebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_995(_9a5);
}},{text:function(_9a6){
return $(_9a6).datetimebox("options").okText;
},handler:function(_9a7){
_995(_9a7);
}},{text:function(_9a8){
return $(_9a8).datetimebox("options").closeText;
...
function _9aa(_9ab){
return (_9ab<10?"0":"")+_9ab;
};
var _9ac=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_9aa(h)+_9ac+_9aa(M);
...
var _9ad=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_9ad);
var hour=parseInt(tt[0],10)||0;
var _9ae=parseInt(tt[1],10)||0;
var _9af=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_9ae,_9af);
}});
})(jQuery);
(function($){
function init(_9b0){
var _9b1=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_9b0);
var t=$(_9b0);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_9b1.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_9b1.bind("_resize",function(e,_9b2){
if($(this).hasClass("easyui-fluid")||_9b2){
_9b3(_9b0);
}
return false;
});
...
var _9b6=$.data(_9b4,"slider");
var opts=_9b6.options;
var _9b7=_9b6.slider;
if(_9b5){
if(_9b5.width){
opts.width=_9b5.width;
}
if(_9b5.height){
opts.height=_9b5.height;
}
}
_9b7._size(opts);
if(opts.mode=="h"){
_9b7.css("height","");
_9b7.children("div").css("height","");
}else{
_9b7.css("width","");
_9b7.children("div").css("width","");
_9b7.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_9b7._outerHeight());
}
_9b8(_9b4);
};
function _9b9(_9ba){
var _9bb=$.data(_9ba,"slider");
...
_9bd(aa);
function _9bd(aa){
var rule=_9bc.find("div.slider-rule");
var _9be=_9bc.find("div.slider-rulelabel");
rule.empty();
_9be.empty();
for(var i=0;i<aa.length;i++){
var _9bf=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_9bf);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_9be);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_9bf,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_9bf,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_9c3.removeClass("slider-h slider-v slider-disabled");
_9c3.addClass(opts.mode=="h"?"slider-h":"slider-v");
_9c3.addClass(opts.disabled?"slider-disabled":"");
_9c3.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _9c5=_9d7(_9c1,left);
_9c6(_9c5);
return false;
}
},onBeforeDrag:function(){
_9c2.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_9c1,opts.value);
},onStopDrag:function(e){
var _9c7=_9d7(_9c1,(opts.mode=="h"?e.data.left:e.data.top));
_9c6(_9c7);
opts.onSlideEnd.call(_9c1,opts.value);
opts.onComplete.call(_9c1,opts.value);
_9c2.isDragging=false;
}});
_9c3.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_9c2.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
var _9c8=_9d7(_9c1,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_9c6(_9c8);
opts.onComplete.call(_9c1,opts.value);
});
function _9c6(_9c9){
var s=Math.abs(_9c9%opts.step);
if(s<opts.step/2){
_9c9-=s;
}else{
_9c9=_9c9-s+opts.step;
}
_9ca(_9c1,_9c9);
};
};
function _9ca(_9cb,_9cc){
var _9cd=$.data(_9cb,"slider");
var opts=_9cd.options;
var _9ce=_9cd.slider;
var _9cf=opts.value;
if(_9cc<opts.min){
_9cc=opts.min;
}
...
opts.value=_9cc;
$(_9cb).val(_9cc);
_9ce.find("input.slider-value").val(_9cc);
var pos=_9d0(_9cb,_9cc);
var tip=_9ce.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_9cb,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _9d1="left:"+pos+"px;";
_9ce.find(".slider-handle").attr("style",_9d1);
tip.attr("style",_9d1+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _9d1="top:"+pos+"px;";
_9ce.find(".slider-handle").attr("style",_9d1);
tip.attr("style",_9d1+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_9cf!=_9cc){
opts.onChange.call(_9cb,_9cc,_9cf);
}
};
function _9b8(_9d2){
var opts=$.data(_9d2,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_9ca(_9d2,opts.value);
opts.onChange=fn;
};
function _9d0(_9d3,_9d4){
var _9d5=$.data(_9d3,"slider");
var opts=_9d5.options;
var _9d6=_9d5.slider;
var size=opts.mode=="h"?_9d6.width():_9d6.height();
var pos=opts.converter.toPosition.call(_9d3,_9d4,size);
if(opts.mode=="v"){
pos=_9d6.height()-pos;
}
if(opts.reversed){
...
function _9d7(_9d8,pos){
var _9d9=$.data(_9d8,"slider");
var opts=_9d9.options;
var _9da=_9d9.slider;
var size=opts.mode=="h"?_9da.width():_9da.height();
var _9db=opts.converter.toValue.call(_9d8,opts.mode=="h"?(opts.reversed?(size-pos):pos):(size-pos),size);
return _9db.toFixed(0);
};
$.fn.slider=function(_9dc,_9dd){
if(typeof _9dc=="string"){
return $.fn.slider.methods[_9dc](this,_9dd);
}
_9dc=_9dc||{};
return this.each(function(){
var _9de=$.data(this,"slider");
if(_9de){
$.extend(_9de.options,_9dc);
}else{
_9de=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_9dc),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_9e1){
var t=$(_9e1);
return $.extend({},$.parser.parseOptions(_9e1,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_9e2){
return _9e2;
},converter:{toPosition:function(_9e3,size){
var opts=$(this).slider("options");
return (_9e3-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_9e4,_9e5){
},onSlideStart:function(_9e6){
},onSlideEnd:function(_9e7){
},onComplete:function(_9e8){
}};
})(jQuery);
